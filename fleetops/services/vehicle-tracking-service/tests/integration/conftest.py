...
from app.api.dependencies import get_broadcaster
...
@pytest_asyncio.fixture
async def broadcaster() -> InMemoryBroadcaster:
    return InMemoryBroadcaster()


@pytest_asyncio.fixture
async def app(session_factory, broadcaster):
    ...
    fastapi_app.dependency_overrides[get_broadcaster] = lambda: broadcaster
