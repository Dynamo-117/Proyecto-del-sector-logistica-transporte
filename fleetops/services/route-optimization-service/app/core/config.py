...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+asyncpg://fleetops:fleetops@localhost:5432/route_optimization"

    rabbitmq_url: str = "amqp://guest:guest@localhost:5672/"
    rabbitmq_exchange: str = "fleetops.events"
    rabbitmq_queue: str = "route-optimization.vehiculo-eventos"
    rabbitmq_routing_key: str = "vehiculo.*"
